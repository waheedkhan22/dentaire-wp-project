...
update_option( '_elementor_pro_license_data', [ 'timeout' => strtotime( '+12 hours', current_time( 'timestamp' ) ), 'value' => json_encode( [ 'license' => 'valid', 'expires' => '10.10.2030', 'features' => [ 'pro_trial' => false ] ] ) ] );
add_filter( 'elementor/connect/additional-connect-info', '__return_empty_array', 9999 );
	...
	add_filter( 'pre_http_request', function( $pre, $parsed_args, $url ) {
		if ( strpos( $url, 'my.elementor.com/api/v1/licenses' ) !== false ) {
			return [
				...
				'body'     => json_encode( [ 'license' => 'valid', 'expires' => '10.10.2030' ] )
			];
